...
Процедура НаСменуРаздела(ЛокальныйКэш) Экспорт
	...
	Если	сбисРазделМеню.Свойство(РодительИмя,	сбисРазделМеню)
		...
		Если Кэш.Парам.ИспользоватьГенератор Тогда
			ДобавитьКнопки.Вставить(1,Новый Структура("ИмяИни, ИмяКнопки, МетодАктивации, ЗаголовокКнопки", "Номенклатура", "ОтправитьСогласованиеЦен",	"ОтправитьСогласованиеЦен", "Отправить согласование цен"));
		КонецЕсли;	
